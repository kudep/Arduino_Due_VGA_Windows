...
data_time1(Color_Style(interactive), Metric_Parameters(15, 5, DATA_STRING_LENGTH, 1)),

//2 string
surname0(Color_Style(information), Metric_Parameters(1, 7, 13, 1)),
surname1(Color_Style(interactive), Metric_Parameters(15, 7, DATA_STRING_LENGTH, 1)),

//3 string
name0(Color_Style(information), Metric_Parameters(1, 9, 13, 1)),
name1(Color_Style(interactive), Metric_Parameters(15, 9, DATA_STRING_LENGTH, 1)),

//4 string
middle_name0(Color_Style(information), Metric_Parameters(1, 11, 13, 1)),
middle_name1(Color_Style(interactive), Metric_Parameters(15, 11, DATA_STRING_LENGTH, 1)),


//5 string
book_numb0(Color_Style(information), Metric_Parameters(1, 13, 13, 1)),
book_numb1(Color_Style(interactive), Metric_Parameters(15, 13, DATA_STRING_LENGTH, 1)),
